        ...
        <div class="page-breadcrumb">
            <div class="row">
                <div class="col-5 align-self-center">
                    <h4 class="page-title">OPERATION MANAGER SECTION</h4>
                </div>
                    ...
                    <div class="d-flex align-items-center justify-content-end">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Operation Manager</li>
                            </ol>
                        </nav>
                    </div>
                </div>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                @include('flash-message')
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Operation Manager</h4>
                            <div class="col-md-12">
                                <div class="row">
    ...
    <div class="col-md-4">
        <div class="card">
            <div class="card-body">
                ...
                <div id="edit_om" class="modal" tabindex="-1" role="dialog" aria-labelledby="vcenter"
                     aria-hidden="true">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="card">
                                            ...
                                            <form action="{{url('superadmin/update-operationmanager')}}" method="POST">
                                            {{ csrf_field() }}
                                                <hr>
                                                <div class="form-body">
                                                    <div class="card-body">
                                                        <div class="row pt-3">
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="form-group has-danger">
                                                                    ...
                                                                    <input type="text" id="om_name" name="om_name"
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="form-group has-danger">
                                                                    ...
                                                                    <input type="email" id="om_email" name="om_email"
                                                                           class="form-control form-control-danger"
                                                                           placeholder="" required>
                                                                    <small class="form-control-feedback"></small>
                                                                </div>
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="form-group has-danger">
                                                                    ...
                                                                    <input type="password" id="om_password" name="om_password"
                                                                           class="form-control form-control-danger"
                                                                           placeholder="" required>
                                                                    <small class="form-control-feedback"></small>
                                                                </div>
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="form-group has-danger">
                                                                    ...
                                                                    <input type="password" id="om_password1" name="om_password1"
                                                                           class="form-control form-control-danger"
                                                                           placeholder="" required>
                                                                    <small class="form-control-feedback"></small>
                                                                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <form action="{{url('superadmin/save-operationmanager')}}" method="POST">
...
$.ajaxSetup({
 ...
 $('.omdeletebtn').click(function (e){
        e.preventDefault();

        var delete_id = $(this).closest("tr").find('.omdelete_val_id').val();
        ...
        if (willDelete) {
            ...
            $.ajax({
                ...
                type:"DELETE",
                url:'/superadmin/delete-operationmanager/'+delete_id,
                data: data,
...
function om_edit(id){
    ...
    $.ajax({
        type: "GET",
        url: "{{ url('superadmin/edit-operationmanager') }}",
        data: {
            id: id
        },
