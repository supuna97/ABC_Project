                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="card">
                                            ...
                                            <form action="{{url('admin/update-productcategory')}}" class="needs-validation" novalidate method="POST">
                                            {{ csrf_field() }}
                                                <hr>
                                                <div class="form-body">
                                                    <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <form action="{{url('admin/save-productcategory')}}" class="needs-validation" novalidate method="POST">  
                                {{ csrf_field() }} 
                                    <hr>
                                    <div class="form-body">
                                        <div class="card-body">
 ...
 $('.pcdeletebtn').click(function (e){
        ...
        if (willDelete) {
            ...
            $.ajax({
                ...
                type:"DELETE",
                url:'/admin/delete-productcategory/'+delete_id,
                data: data,
...
function pc_edit(id){
    ...
    $.ajax({
        type: "GET",
        url: "{{ url('admin/edit-productcategory') }}",
        data: {
            id: id
        },
