                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <form action="{{url('operationmanager/save-item')}}" class="needs-validation" novalidate method="POST" enctype="multipart/form-data">  
                                {{ csrf_field() }} 
                                    <hr>
                                    <div class="form-body">
                                        <div class="card-body">
 ...
 $('.itemdeletebtn').click(function (e){
        ...
        if (willDelete) {
            ...
            $.ajax({
                ...
                type:"DELETE",
                url:'/operationmanager/delete-item/'+delete_id,
                data: data,
...
function item_edit(id){
    ...
    $.ajax({
        type: "GET",
        url: "{{ url('operationmanager/edit-item') }}",
        data: {
            id: id
        },
